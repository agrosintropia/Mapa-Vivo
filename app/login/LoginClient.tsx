    ...
    <div className="card max-w-sm w-full text-center space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-2">
          Entre com sua conta Google para acessar o painel de gestão.
        </p>
      </div>
      ...
      <p className="text-xs text-gray-400">
        Apenas gestores e técnicos autorizados podem acessar o painel.
        Moradores podem acessar o mapa e fichas das árvores sem login.
      </p>
    </div>
  );
}
